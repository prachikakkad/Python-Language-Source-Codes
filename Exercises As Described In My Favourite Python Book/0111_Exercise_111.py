...
from Extra_file_for_Exercise_111 import Employee

class TestEmployee(unittest.TestCase):
    def setUp(self):
        self.Prachi = Employee('Prachi', 'Kakkad', 65000)

    def test_give_default_raise(self):
        self.Prachi.give_raise()
        self.assertEqual(self.Prachi.salary, 70000)

    def test_give_custom_raise(self):
        self.Prachi.give_raise(10000)
        self.assertEqual(self.Prachi.salary, 75000)
